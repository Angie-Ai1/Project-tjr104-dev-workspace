    ...
    with col_right:
        ...
        with c1:
            st.markdown(f"""<div class='top-card danger'>
                ...
                <div class='tc-value'>PDI平均 {worst_pdi:.2f} <span>分</span></div>
        ...
        with c2:
            st.markdown(f"""<div class='top-card neutral'>
                ...
                <div class='tc-value'>PDI平均 {nat_avg_pdi:.2f} <span>分</span></div>
        ...
        with c3:
            st.markdown(f"""<div class='top-card highlight'>
                ...
                <div class='tc-value'>PDI平均 {curr_pdi_base:.2f} <span>分</span></div>
        ...
        with c4:
            st.markdown(f"""<div class='top-card safe'>
                ...
                <div class='tc-value'>PDI平均 {best_pdi:.2f} <span>分</span></div>
        ...
        if not df_nat.empty:
            ...
            if not target_hist.empty:
                target_hist['平均 PDI'] = target_hist['pdi_mean'].apply(lambda x: f"{x:.2f}")
