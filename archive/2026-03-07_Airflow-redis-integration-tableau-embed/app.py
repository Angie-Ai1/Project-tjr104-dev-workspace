...
from pages.v_act2_overview import act2_render ## page -> pages
from pages.v_act3_avoid import act3_render    ## page -> pages
from pages.v_act4_gov import act4_render      ## page -> pages
from pages.v_act5_policy import act5_render   ## page -> pages
from pages.v_act6_chat import act6_render     ## page -> pages
