...
def render_sidebar(df_market):
    ...
    st.sidebar.page_link("pages/act1_home.py", label="夜市行人地獄(?)", icon="🔥")
    st.sidebar.page_link("pages/act2_overview.py", label="夜市老實說", icon="📝")
    st.sidebar.page_link("pages/act3_avoid.py", label="行人看這裡", icon="🚶")
    st.sidebar.page_link("pages/act4_gov.py", label="政府幫幫忙", icon="🏛️")
    st.sidebar.page_link("pages/act5_policy.py", label="政策來檢驗", icon="✅")
    st.sidebar.page_link("pages/act6_chat.py", label="AI 小幫手", icon="💬")
    st.sidebar.markdown("---")
    # 加入組員的頁面
